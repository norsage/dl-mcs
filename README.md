...
| 9. Графовые нейронные сети.<br><br><br> | [Запись 28.10.2025](https://disk.yandex.ru/i/44PmP6r5Q2jV8A) <br><br> [GNN и Pytorch Geometric](notebooks/gnn.ipynb) <br> | [Предсказание свободной энергии связывания белков](assignments/binding_affinity.ipynb) <br>  Дедлайн: 26.11 23:59 <br>|
